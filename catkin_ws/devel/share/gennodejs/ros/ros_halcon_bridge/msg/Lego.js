...
// (in-package ros_halcon_bridge.msg)
...
class Lego {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('lenght')) {
        this.lenght = initObj.lenght
      }
      else {
        this.lenght = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [lenght]
    bufferOffset = _serializer.float32(obj.lenght, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [lenght]
    data.lenght = _deserializer.float32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.lenght !== undefined) {
      resolved.lenght = msg.lenght;
    }
    else {
      resolved.lenght = 0.0
    }
